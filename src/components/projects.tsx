...
import FolioImage from '../../public/assets/projects/portfolio-site.png'
    ...
    <div className="w-full">
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            ...
            <Project name="My Personal Website" tech="Next.js" image={FolioImage} externalLink="" githubLink="https://github.com/NicoleSelig/folio" />
        </div>
      </div>
    </div>
  );
